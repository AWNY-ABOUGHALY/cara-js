    ...
    cart.addEventListener("click",()=>{
        if(itemsOrder.children.length === 0) { 
            ...
            <div class="itemdetails d-flex w-100 bg-white justify-content-evenly py-1 align-items-center fw-bold my-1">
               <div class="text-danger"><i id="closeitem${index +1}" class="fa-solid fa-circle-xmark deleteitem"></i></div>
               <div class="itemdetailsimg"><img class="mw-100 rounded-3" src="${itemImg.getAttribute("src")}"></div>
               <div><h5 class="fw-bold my-auto">${itemTitle.textContent}</h5></div>
               <div class="allpricequantity pricequantity${index +1}">${priceItemQunty}</div>
            ...
            plusItem.addEventListener("click",()=>{
                if (itemCount < 10) {
                    ...
                    priceItemQunty = `${eval(itemPrice.textContent*itemCount).toFixed(2)}`
        ...
        } else if (itemsOrder.children.length > 0 && itemsOrder.children.length < 5) {
            ...
            if(mapCheck.includes(true) === true) {
                ...
                myAttention.innerHTML = "Already in your bag If you still want more, do that from your Shopping Bag"
            ...
            if(mapCheck.includes(true) === true) {
                ...
                myAttention.innerHTML = "You have reached the limit, Just 5 different items you can choose in one order"
